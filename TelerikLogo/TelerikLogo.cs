...
class TelerikLogo
{
    static void Main()
    {
        ...
        Console.WriteLine("{0}*{1}*{0}",
            new string('.', x / 2), new string('.', innerDots));
        ...
        for (int i = 0; i < z - 1; i++)
        {
            ...
            Console.WriteLine("{0}*{1}*{2}*{1}*{0}",
                new string('.', outerDots), new string('.', middleDots), new string('.', innerDots));
        ...
        {
            Console.WriteLine("{0}*{1}*{0}",
            new string('.', outerSquareDots), new string('.', innerSquareDots));
            innerSquareDots += 2;
            outerSquareDots--;
        }
